...
def test_models():
    ...
    try:
        ...
        # Enum 테스트
        _test_result("models_enum_risk", RiskLevel.CRITICAL.value == "critical",
                    f"RiskLevel.CRITICAL = {RiskLevel.CRITICAL.value}")
        _test_result("models_enum_hedge", HedgeAction.PARTIAL_CLOSE.value == "partial_close",
        ...
        _test_result("models_position", pos.symbol == "ETHUSDT" and pos.leverage == 20,
        ...
        _test_result("models_market", ms.btc_price == 95000 and ms.btc_level == 2,
        ...
        _test_result("models_context", len(ctx.positions) == 1 and ctx.account_balance == 1000,
...
def test_analyst_agent():
    ...
    try:
        ...
        _test_result("analyst_inheritance",
...
def test_risk_agent():
    ...
    try:
        ...
        agent = RiskAgent()
        _test_result("risk_init", agent.agent_id == "risk",
                    f"id={agent.agent_id}")

        from agents.core.base import AgentBase
        _test_result("risk_inheritance", isinstance(agent, AgentBase),
                    "AgentBase 상속 확인")
        ...
        _test_result("risk_no_positions",
        ...
        _test_result("risk_normal_position",
        ...
        _test_result("risk_danger_position",
...
def test_hedge_agent():
    ...
    try:
        ...
        agent = HedgeAgent()
        _test_result("hedge_init", agent.agent_id == "hedge",
                    f"id={agent.agent_id}")

        from agents.core.base import AgentBase
        _test_result("hedge_inheritance", isinstance(agent, AgentBase),
                    "AgentBase 상속 확인")
        ...
        _test_result("hedge_partial_close",
...
def test_leverage_agent():
    ...
    try:
        ...
        agent = LeverageAgent()
        _test_result("leverage_init", agent.agent_id == "leverage",
                    f"id={agent.agent_id}")

        from agents.core.base import AgentBase
        _test_result("leverage_inheritance", isinstance(agent, AgentBase),
                    "AgentBase 상속 확인")
...
def test_pipeline():
    ...
    try:
        ...
        _test_result("pipeline_scenario3_empty",
